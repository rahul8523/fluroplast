                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            High-performance fluoropolymer components engineered
                            to survive extreme engine heat and aggressive fuels;
                            reducing friction, lowering emissions, and enhancing
                            vehicle longevity.
                        </p>
