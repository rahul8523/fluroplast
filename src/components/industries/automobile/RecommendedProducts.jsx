...
const sections = [
  ...
  {
    title: "Fluoropolymer Tubing & Insulation Range",
    items: [
      "PVDF pipes",
      "FEP tubes",
  ...
  {
    title: "High-Performance Engineering Materials",
    items: [
      ...
      <div className="container">
        ...
        ">
          ...
          <p className="
            ...
            text-left
          ">
            Best-suited product categories from our portfolio
