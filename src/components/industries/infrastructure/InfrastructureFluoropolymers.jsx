...
const benefits = [
  ...
  "Excellent compressive strength (filled grades)",
  ...
  "Long service life in inaccessible structural locations",
];

export default function InfrastructureFluoropolymers() {
  return (
    <section className="
      relative
      overflow-hidden
