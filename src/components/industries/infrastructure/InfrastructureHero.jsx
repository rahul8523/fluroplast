                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <h1 className="text-[30px] md:text-[50px] leading-[1.05] font-bold mb-7 tracking-[-2px]">
                           Infrastructure / Bridges Industry
                        </h1>

                        {/* DESCRIPTION */}
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            High-performance fluoropolymer solutions for the most demanding chemical environments - ensuring reliability, safety, and longevity.
                        </p>
