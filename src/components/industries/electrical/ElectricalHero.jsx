...
import automobileImg from "../../../assets/images/industries/electronic/electronic.jpg";
                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            Ultra-high dielectric, low-loss fluoropolymers for hig -frequency electronics ensuring signal integrity, thermal stability, and reliable insulation.
                        </p>
