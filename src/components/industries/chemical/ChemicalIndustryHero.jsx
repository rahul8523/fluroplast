...
import automobileImg from "../../../assets/images/industries/chemical/Chemical.jpg";

export default function ChemicalIndustryHero() {
    return (
                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            High-performance fluoropolymer solutions for the most
                            demanding chemical environments — ensuring reliability,
