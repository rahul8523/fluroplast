...
import automobileImg from "../../../assets/images/industries/food/food.png";
                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            FDA-compliant and high-purity fluoropolymer solutions designed for safe, non-stick, and contamination-free food processing and packaging.
                        </p>
