...
import automobileImg from "../../../assets/images/industries/Irrigation/Irrigation.jpg";
                ...
                <div className="container mx-auto">
                    ...
                    <div className="max-w-[620px] text-white">
                        ...
                        <h1 className="text-[30px] md:text-[50px] leading-[1.05] font-bold mb-7 tracking-[-2px]">
                           Irrigation / Sanitary / Pipe & Fittings Industry
                        </h1>

                        {/* DESCRIPTION */}
                        <p className="text-[18px] md:text-[20px] leading-[1.35] text-gray-200 font-medium mb-10">
                            Robust fluoropolymer systems designed for leak-proof fluid handling, chemical injection, and high-durability plumbing in agricultural and municipal infrastructure.
                        </p>
